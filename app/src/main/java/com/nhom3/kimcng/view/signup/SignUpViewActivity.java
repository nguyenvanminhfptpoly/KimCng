package com.nhom3.kimcng.view.signup;
...
import com.nhom3.kimcng.Service.APIUltil;
import com.nhom3.kimcng.Service.DataClient;
import com.nhom3.kimcng.presenter.signup.SignUpPresenter;
...
public class SignUpViewActivity extends AppCompatActivity implements SignUpView {
                            ...
                            callb.enqueue(new Callback<String>() {
                                ...
                                public void onResponse(Call<String> call, Response<String> response) {
                                    ...
                                    if(result.equals("Success")){
                                        Toast.makeText(SignUpViewActivity.this, "Thêm thành công", Toast.LENGTH_SHORT).show();
                                        finish();
                                ...
                                public void onFailure(Call<String> call, Throwable t) {
                                    Toast.makeText(SignUpViewActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
